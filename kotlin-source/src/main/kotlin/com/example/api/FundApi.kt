...
import com.example.flow.FundFlow.Initiator
import com.example.schema.FundSchemaV1
...
class FundApi(private val rpcOps: CordaRPCOps) {
    ...
    fun myfunds(): Response {
        ...
        val results = builder {
                var partyType = FundSchemaV1.PersistentIOU::fundManager.equal(rpcOps.nodeInfo().legalIdentities.first().name.toString())
